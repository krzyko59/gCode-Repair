# gCode Repair
**Program konsolowy pisany w języku C++ (visual studio) na platforme Windows**</br>
**Przekształcający kod maszynowy (GCODE), maszyny marki ECKERT, generowany przez program Lantek**</br></br>
Program ten: </br>
- udoskonala kod maszynowe o funkcje które nie są możliwe do wdrożenia bezpośrednio z programu do generowania GCODE</br>
